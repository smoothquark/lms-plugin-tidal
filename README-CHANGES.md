...
I have been expermenting with HiRes / Dolby Atmos support. Initial testing thus far:
...
3. Regardless of the client id/secret used, sample size/rate is automatically set as 24/48,000 for HiRes and Dolby Atmos if DASH and Atmos are enabled.
...
10. I am planning to add support to show [E] for explicit tracks.
